...
function template_scripts() {
	...
	wp_enqueue_style( 'template-style1', 'https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i&display=swap	', array(), _S_VERSION );
	wp_enqueue_style( 'template-style2', get_template_directory_uri() . '/vendor/bootstrap/css/bootstrap.min.css', array(), _S_VERSION );
	wp_enqueue_style( 'template-style3', get_template_directory_uri() . '/assets/css/fontawesome.css', array(), _S_VERSION );
	wp_enqueue_style( 'template-style4', get_template_directory_uri() . '/assets/css/templatemo-stand-blog.css', array(), _S_VERSION );
	wp_enqueue_style( 'template-style5', get_template_directory_uri() . '/assets/css/owl.css', array(), _S_VERSION );
	...
	wp_enqueue_script( 'customjs', get_template_directory_uri() . '/assets/js/custom.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'owljs', get_template_directory_uri() . '/assets/js/owl.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'slickjs', get_template_directory_uri() . '/assets/js/slick.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'isotopejs', get_template_directory_uri() . '/assets/js/isotope.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'accordingsjs', get_template_directory_uri() . '/assets/js/accordions.js', array(), _S_VERSION, true );
